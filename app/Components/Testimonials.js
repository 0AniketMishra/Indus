  ...
  return (
    <div>
          <section class="text-gray-400 bg-background body-font">
              <div class="container max-w-custom px-5 py-12 mx-auto" bis_skin_checked="1">
                  ...
                  <div class="flex flex-wrap -m-4" bis_skin_checked="1">
                      <div class="p-4 md:w-1/2 w-full" bis_skin_checked="1">
                          <div class="h-full bg-gray-800 bg-opacity-40 p-8 rounded-xl" bis_skin_checked="1">
                              ...
                              <a class="inline-flex items-center">
                                  <img alt="testimonial" src="https://dummyimage.com/106x106" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
                                      <span class="flex-grow flex flex-col pl-4">
                                          ...
                                          <span class="text-acsent text-sm">UI DEVELOPER</span>
                                      </span>
                              </a>
                          </div>
                      </div>
                              ...
                              <a class="inline-flex items-center">
                                  <img alt="testimonial" src="https://dummyimage.com/107x107" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
                                      <span class="flex-grow flex flex-col pl-4">
                                          ...
                                          <span class="text-acsent text-sm">DESIGNER</span>
                                      </span>
                              </a>
                          </div>
                      </div>
