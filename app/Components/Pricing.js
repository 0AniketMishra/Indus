...
function Pricing() {
  return (
      <section class="text-gray-400 bg-background body-font ">
          <div class="container px-5 py-12 mx-auto max-w-custom" bis_skin_checked="1">
              <div class="flex flex-col text-center w-full mb-20" bis_skin_checked="1">
                  ...
                  <div class="flex mx-auto border-2 border-acsent rounded-lg overflow-hidden mt-6" bis_skin_checked="1">
                      <button class="py-1 px-4 bg-acsent text-white focus:outline-none">Monthly</button>
              ...
              <div class="flex flex-wrap -m-4" bis_skin_checked="1">
                  <div class="p-4 xl:w-1/4 md:w-1/2 w-full" bis_skin_checked="1">
                      <div class="h-full p-6 rounded-2xl border-2 border-gray-700 flex flex-col   overflow-hidden" bis_skin_checked="1">
                          ...
                          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-green-500 rounded">Button
                  ...
                  <div class="p-4 xl:w-1/4 md:w-1/2 w-full" bis_skin_checked="1">
                      <div class="h-full p-6 rounded-2xl border-2 border-acsent flex flex-col   overflow-hidden" bis_skin_checked="1">
                          ...
                          <button class="flex items-center mt-auto text-white bg-acsent border-0 py-2 px-4 w-full focus:outline-none hover:bg-green-500 rounded">Button
                              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                              </svg>
                          </button>
