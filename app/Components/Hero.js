  ...
  return (
      <section className="flex mx-auto max-w-custom pt-24 pb-10 lg:py-6 items-center  sm:px-6  lg:px-4">
          ...
          <div className=" lg:w-1/3 my-4  ">
                  <img className=" w-fit overflow-hidden invert animate-spin-slow rounded-xl" src="https://raw.githubusercontent.com/0AniketMishra/HexaGon/refs/heads/main/4a1c1d25052123856e0db2b2847cd009-removebg-preview.png" alt=""/>
